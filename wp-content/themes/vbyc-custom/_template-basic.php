        ...
        <section class="main-content">
            <div class="container"> 
                <article class="main-article">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 class="heading">Re-flowing column - fixed width (300px)</h3>
                            <div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 class="heading">Re-flowing column - em width (15em)</h3>
                            <div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 class="heading">Re-flowing column count (3)</h3>
                            <div>
